...
public class ArcadeKart : MonoBehaviour
{
    ...
    {
        m_CanMove = accelerate;
        float accelInput = (accelerate ? 1.0f : 0.0f) - (brake ? 1.0f : 0.0f);
        Debug.Log("mmm" + accelerate + brake + turnInput+ accelInput);
        ...
        Debug.Log("vvvv " + finalAccelPower + finalAcceleration);
        ...
        if (GroundPercent > 0.0f)
        {
            ...
            if (!localVelDirectionIsFwd && !accelerate)
